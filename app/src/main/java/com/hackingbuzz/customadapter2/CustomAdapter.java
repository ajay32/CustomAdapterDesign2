...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        callNchat.setImageResource(position%2==0?R.mipmap.ic_launcher: R.drawable.whatsapp);   // see we checking if position of view is even put call image nai to whatsapp

        number.setText((position+1) + " in the list");  // it disply on text view just
